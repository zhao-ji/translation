...
export const translationActions = {
    googleTranslate: kwargs => dispatch => {
        ...
        if (kwargs.text && kwargs.text.length >= 2) {
            ...
            dispatch({ type: "GOOGLE_TRANSLATION_SUCCESS", result: "", kwargs });
        }
    },
    baiduTranslate: kwargs => dispatch => {
        ...
        if (kwargs.text && kwargs.text.length >= 2) {
            ...
            dispatch({ type: "BAIDU_TRANSLATION_SUCCESS", result: "", kwargs });
        }
    },
    youdaoTranslate: kwargs => dispatch => {
        ...
        if (kwargs.text && kwargs.text.length >= 2) {
            ...
            dispatch({ type: "YOUDAO_TRANSLATION_SUCCESS", result: "", kwargs });
        }
    },
}
